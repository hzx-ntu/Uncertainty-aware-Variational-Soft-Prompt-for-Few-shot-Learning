...
class CSMEmbedder(BaseEmbedder):
    ...
    def __init__(
        ...
        **kwargs
        ...
        #print('msk_embed shape: ', self.msk_embed.shape)
    ...
    def prep_batch(
        ...
        #print('inputs shape: ', batch_out['inputs'].shape)
        batch_out =  self.add_cls_embed(batch=batch_out,prompt_embed=prompt_embed)
        #print('inputs_embeds shape: ', batch_out['inputs_embeds'].shape)
    ...
    def add_cls_embed(
        ...
        #print('Initial seq_lengths: ', sequence_lengths.shape, sequence_lengths) #hzx
        inputs_embeds = []
        
        #print('cls_embed shape: ', self.cls_embed.shape)
        
        if 't_rs' in batch:
            t_rs = []
        
        #print('Len of seq_lengths: ', len(sequence_lengths)) #hzx
        ...
        batch['prompt_embed'] = prompt_embed #hzx added
        
        batch['inputs_embeds'] = torch.stack(
            inputs_embeds,
            dim=0
        )
        #print('inputs shape: ', batch['inputs'].shape) #hzx 
        #print('inputs_embeds shape: ', batch['inputs_embeds'].shape) #hzx 
